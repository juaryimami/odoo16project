...
class HrContract(models.Model):
    ...
    training_allowance = fields.Monetary(string="Training Allowance",help="Training Allowance")
    representation_allowance = fields.Monetary(string="Representation Allowance", help="Representation Allowance")
