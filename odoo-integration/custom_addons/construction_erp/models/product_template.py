...
class ProductTemplate(models.Model):
    ...
    total_project_units = fields.Integer(string='Total Project Units', compute='_compute_project_pool_stats', 
                                         help="Total units defined across all projects for this product.")
    ...
    def _compute_project_pool_stats(self):
        for template in self:
            ...
            template.total_project_units = sum(units.mapped('total_quantity'))
