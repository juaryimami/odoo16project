...
class ResConfigSettings(models.TransientModel):
    ...
    construction_logo = fields.Binary(related='company_id.construction_logo', readonly=False)
    requisition_reminder_days = fields.Integer(string="Requisition Reminder Days", default=3, config_parameter='construction_erp.requisition_reminder_days')
    ...
    twilio_whatsapp_template_id = fields.Char(string='WhatsApp Template SID', config_parameter='construction_erp.whatsapp_installment_template_sid', help="Template SID (HX...) to bypass 24h window")
